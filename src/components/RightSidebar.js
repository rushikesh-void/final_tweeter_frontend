            ...
            return (
              <div key={user?._id} className='flex items-center justify-between my-3'>
                <div className='flex'>
                  ...
                  <img src={"https://img.freepik.com/free-photo/3d-rendering-cartoon-boy_23-2150797600.jpg?semt=ais_hybrid&w=740"} alt ='cartoon' className='size-12 shrink-0 rounded-xl'/>
